...
install_socks5(){
  ...
  if [ ! -e "${FILE_PATH}/s5" ]; then
    curl -L -sS -o "${FILE_PATH}/s5" "https://github.com/renyuanceshi/socks5-script/releases/download/freebsd/web"
  else
...
if [ "$crontabgogogo" == "Y" ]; then
  ...
  curl -s https://raw.githubusercontent.com/renyuanceshi/socks5/main/check_cron.sh | bash
else
